...
class TestMatrixLoader(unittest.TestCase):
    def test_simple_csv(self):
        ...
        sample2class={"id1":1,"id2":1,"id3":2,"id4":3,"id5":3,"id6":1}
        ...
        o_dm, o_relevance, o_sample2class, _ = wi19.load_dm(fsubm.name,fgt.name)

        np.testing.assert_array_equal(o_dm, dm, err_msg='Distance matrix wrong.', verbose=True)
        np.testing.assert_array_equal(o_relevance, relevance, err_msg='Relevance vector wrong.', verbose=True)
